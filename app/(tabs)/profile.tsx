      ...
      <View className="mt-7 rounded-3xl bg-card p-5 dark:bg-darkSurface">
        ...
        <View className="mt-4 flex-row flex-wrap gap-3">
          {tags.length > 0 ? tags.map((t) => (
            <View key={t.id} className="min-h-11 items-center justify-center rounded-full bg-periwinkle-soft px-4 dark:bg-darkSurfaceSoft">
              <Text className="text-sm font-semibold text-navy dark:text-cloud">{t.label}</Text>
            </View>
          )) : (
