    ...
    <Screen scroll={false}>
      <View className="flex-1">
        <View className="flex-row gap-2 pb-6">
          {[1, 2, 3].map((item) => (
            <View key={item} className={`h-1.5 flex-1 rounded-full ${item <= step ? "bg-maroon" : "bg-periwinkle-soft dark:bg-darkSurfaceSoft"}`} />
          ))}
        </View>
        ...
        <Text className="text-sm text-muted dark:text-darkMuted">Step {step} of 3</Text>

        <View className="mt-2 flex-1">
          {step === 1 ? (
            <>
              <Text className="text-3xl font-extrabold text-navy dark:text-cloud">What is your skin type?</Text>
              <Text className="mt-2 text-base text-muted dark:text-darkMuted">This helps us recommend the right products for you.</Text>
          ...
          {step === 2 ? (
            <>
              <Text className="text-3xl font-extrabold text-navy dark:text-cloud">Any skin conditions?</Text>
              <Text className="mt-2 text-base text-muted dark:text-darkMuted">Select all that apply (optional).</Text>
              <ScrollView className="mt-6 flex-1" contentContainerClassName="gap-3 pb-6" showsVerticalScrollIndicator={false}>
          ...
          {step === 3 ? (
            <>
              <Text className="text-3xl font-extrabold text-navy dark:text-cloud">What are your main concerns?</Text>
